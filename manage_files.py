...
# python manage_files.py   --excel assets/documents/master/10.list_docs_oktober_2025.xlsx   --files-dir assets/files/ --bupel 10.OKTOBER  --echo-dir assets/documents/echo   --update-status   --verbose   --dry-run
